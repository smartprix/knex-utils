...
/**
 * @typedef {{table_schema: string, table_name: string, table_type: string, comment: string | null}} table
 */
...
/** @typedef {{constraint_name: string, constraint_def: string, constraint_type: string}} constraintInfo */
